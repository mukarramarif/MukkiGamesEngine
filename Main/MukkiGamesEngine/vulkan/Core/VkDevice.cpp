...
// Fix 1: Implement findQueueFamilies properly
...
{
    // Create a temporary command pool for the transfer operation
    ...
    std::cout << "Buffer copied successfully: " << size << " bytes" << std::endl;
}